...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', '@)0qp0!&-vht7k0wyuihr+nk-b8zrvb5j^1d@vl84cd1%)f=dz')
...
STATIC_ROOT = os.environ.get('DJANGO_STATIC_ROOT', os.path.join(PROJECT_DIR, 'staticfiles'))
